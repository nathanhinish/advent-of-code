...
assert.equal(test1.content, 2021);
...
assert.equal(test2.subpackets[0].content, 10);
assert.equal(test2.subpackets[1].raw, "0101001000100100");
assert.equal(test2.subpackets[1].content, 20);
...
assert.equal(test3.subpackets[0].content, 1);
assert.equal(test3.subpackets[1].raw, "10010000010");
assert.equal(test3.subpackets[1].content, 2);
assert.equal(test3.subpackets[2].raw, "00110000011");
assert.equal(test3.subpackets[2].content, 3);
